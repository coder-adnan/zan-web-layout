...
const About = () => {
  return (
    <>
      <div
        className="flex flex-col md:flex-row justify-center mt-20"
        id="about"
      >
        <div className="w-full md:w-1/4 px-4">
          <h1 className="-mt-6 text-xl text-gray-600 text-center md:text-left">
            About Us
          </h1>
        </div>
        <div className="w-full md:w-1/3 px-4">
          ...
          <p className="pr-0 md:pr-16 text-justify text-gray-600">
        ...
        <div className="w-full md:w-1/3 flex justify-center px-4">
          <Image
            ...
            alt="about-image"
            width={400}
            height={300} // Optional: Specify height for better responsiveness
          />
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-center mt-20">
        ...
        <div className="w-full md:w-1/3 flex items-end px-4">
          <h1
            className={`${raleway.className} text-green-900 font-semibold text-4xl`}
          >
            Unwavering Commitment to Perfection
          </h1>
        </div>
        <div className="w-full md:w-1/3 flex justify-center px-4 flex-col gap-4">
      ...
      <div className="flex justify-end ">
        <div className="w-full md:w-3/4 md:px-16 px-6">
          <button className="w-full hover:bg-transparent hover:border transition-all border-green-900 hover:border-green-900 hover:text-gray-900 mt-24 px-4 py-4 uppercase bg-green-900 text-gray-200">
            Learn More
          </button>
        </div>
      </div>
